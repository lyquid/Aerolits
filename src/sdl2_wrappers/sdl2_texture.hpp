...
class SDL2_Texture {
  ...
  */
   ...
   */
  inline int setAlphaMod(Uint8 alpha) { return SDL_SetTextureAlphaMod(texture_, alpha); }
   ...
   * @return Returns 0 on success or a negative error code on failure.
   */
  inline int setBlendMode(const SDL_BlendMode& mode) const { return SDL_SetTextureBlendMode(texture_, mode); }
   ...
   * @return Returns 0 on success or a negative error code on failure.
   */
  inline int setColorMod(Uint8 r, Uint8 g, Uint8 b) const { return SDL_SetTextureColorMod(texture_, r, g, b); }
  ...
  */
   ...
   * @return True on success, or false on errors.
   */
  static bool queryTexture(const SDL2_Texture& texture, Uint32* format, int* access, int* width, int* height);
